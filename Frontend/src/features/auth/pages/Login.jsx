...
import { X, AlertCircle, GraduationCap, User } from "lucide-react"
      ...
      <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl p-8 w-full max-w-md shadow-2xl border border-slate-700/50">
        ...
        <div className="relative flex items-center justify-center mb-6">
          ...
          <div className="relative bg-slate-900/80 px-4">
            <span className="text-slate-400 text-sm font-medium">o continúa con email</span>
          </div>
        </div>
        ...
        <div className="text-center mt-6 space-y-3">
          ...
          <div>
            <BotonLink to="/recover" variant="outline" size="sm">
